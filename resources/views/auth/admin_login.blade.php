            ...
            @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input name="email" :value="old('email')" required autofocus class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Username">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
